...
# train_data = prep.read_data('E:/Py_Project/nsmc/ratings_train.txt')
...
# # train_labels = np.array([row[2] for row in train_data]).reshape(-1,)
...
# # test_labels = np.array([row[2] for row in test_data]).reshape(-1, 1)
