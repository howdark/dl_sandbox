...
tf.app.flags.DEFINE_boolean("inference", True, "예측을 합니다.")
tf.app.flags.DEFINE_boolean("data_loop", True, "작은 데이터셋을 실험해보기 위해 사용합니다.")
tf.app.flags.DEFINE_integer("batch_size", 100, "미니 배치 크기")
tf.app.flags.DEFINE_integer("epoch", 5000, "총 학습 반복 횟수")

tf.app.flags.DEFINE_string("data_path", "./data/news_filtered_test.csv", "대화 파일 위치")
# tf.app.flags.DEFINE_string("data_path", "./data/news_filtered.csv", "대화 파일 위치")
tf.app.flags.DEFINE_string("voc_path", "./data/news.voc", "어휘 사전 파일 위치")
